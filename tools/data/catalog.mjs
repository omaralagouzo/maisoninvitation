...
export const INVITATION_DEFINITION = {
  ...
  fields: [
    ...
    { key: 'hosts', name: 'Hosts', type: 'multi_line_text_field', description: 'Optional — the families or people hosting. (Not shown in the Été design.)' },
    { key: 'invitation_message', name: 'Invitation wording', type: 'multi_line_text_field', description: '(Not shown in the Été design.)' },
    ...
    { key: 'show_map', name: 'Embed map', type: 'boolean', description: '(Not shown in the Été design, which links to the map from each celebration card.)' },
    { key: 'schedule', name: 'Programme', type: 'multi_line_text_field', description: 'One item per line: "7:00 PM | Guest arrival".' },
    { key: 'celebrations', name: 'Celebrations (Été design)', type: 'multi_line_text_field', description: 'One event card per line: "Title | Venue | YYYY-MM-DD | HH:MM (24-hour) | Map link | Note", e.g. "The Hen | The Grand Hotel | 2027-09-30 | 15:00 | https://maps.app.goo.gl/… | ladies welcome". Leave a part empty to use the main venue, date, time or map link. Blank field = one card for the wedding.' },
    ...
    { key: 'dress_code', name: 'Dress code', type: 'single_line_text_field', description: '(Not shown in the Été design.)' },
    { key: 'story', name: 'A note from the couple', type: 'multi_line_text_field', description: '(Not shown in the Été design.)' },
